...
use crate::b3_verify::entry::{BorrowedEntry, BorrowedLink};
use crate::b3_verify::hasher::b3::IV;
use crate::b3_verify::hasher::iv::IV;
use crate::b3_verify::utils::{is_valid_filename_len, is_valid_symlink};
...
pub fn write_entry_transcript(
    ...
    let (mut flag, content, clen, is_sym) = match entry.link {
        crate::b3_verify::entry::BorrowedLink::Content(hash) => (0, hash.as_slice(), 32, false),
        crate::b3_verify::entry::BorrowedLink::Path(link) => {
