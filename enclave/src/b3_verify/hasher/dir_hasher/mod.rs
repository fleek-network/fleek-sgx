...
use crate::b3_verify::utils::{flatten, is_valid_filename, is_valid_symlink, Digest};
...
mod tests {
    use super::*;
    use crate::{
        b3_verify::hasher::SkipHashTreeCollector,
        b3_verify::test_utils::{entry, hash_mock_dir_entry},
    };
